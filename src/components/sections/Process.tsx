      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {processSteps.map((step, index) => (
            <div key={index} className="bg-denim-medium/30 p-8 rounded-lg border border-denim-light/20 text-center">
              <div className="bg-accent-mustard text-denim-dark rounded-full w-16 h-16 mx-auto mb-6 flex items-center justify-center">
                {step.icon}
              </div>
